...
class TableSystem(object):
    def __init__(self, args, text_detector=None, text_recognizer=None):
        ...
        if args.table_algorithm in ["TableMaster"]:
            ...
            self.match = TableMatch(
                ...
                match_mode=getattr(args, "table_match_mode", "legacy"),
                diagnostics_path=getattr(args, "table_match_diagnostics_path", None),
            )
    ...
    def __call__(self, img, return_ocr_result_in_table=False):
        ...
        result["cell_bbox"] = [normalize_xyxy_box(x) for x in structure_res[1].tolist()]
