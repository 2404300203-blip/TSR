...
def init_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="legacy",
        choices=["legacy", "ocr_aware_hungarian"],
        help="OCR-to-cell matching strategy for table HTML reconstruction.",
    )
    parser.add_argument(
        "--table_match_diagnostics_path",
        type=str,
        default=None,
        help="Optional JSONL path for OCR-aware table matching diagnostics.",
    )
