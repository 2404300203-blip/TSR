...
def build_neck(config):
    ...
    from .csp_pan import CSPPAN, CSPPAN_YOLOHeader
    from .ct_fpn import CTFPN
    from .fpn_unet import FPN_UNet
    from .rf_adaptor import RFAdaptor
    from .financial_structure_attention import FinancialStructureAttention
    from .global_local_mamba_fusion import GlobalLocalMambaFusion
    from .yolo_mabe_fusion import YOLOMabeFusion
    ...
    support_dict = [
        ...
        "CTFPN",
        "RFAdaptor",
        "FinancialStructureAttention",
        "GlobalLocalMambaFusion",
        "YOLOMabeFusion",
        "FPN_UNet",
    ]
