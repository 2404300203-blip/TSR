...
from ppocr.modeling.heads.cell_dual_branch_mamba_head import CellDualBranchMambaHead
from ppocr.losses.table_att_loss import SLACellTokenLoss


def test_dual_branch_head_forward_backward():
    paddle.seed(123)
    head = CellDualBranchMambaHead(
